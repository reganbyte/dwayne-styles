...
export const ConfettiExtension = {
 ...
 (trace.payload && trace.payload.name === 'ext_confetti'),
  effect: ({ trace }) => {
...
//needed to update trace payload checking logic from Discord chat 
export const FeedbackExtension = {
  name: 'Feedback',
  type: 'response',
  match: ({ trace }) =>
    trace.type === 'ext_feedback' || (trace.payload && trace.payload.name === 'ext_feedback'),
  render: ({ trace, element }) => {
